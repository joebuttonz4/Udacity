                ...
                <div className="flex flex-col gap-2">
                  {previewCandidates.map((candidate) => (
                    ...
                    >
                      ...
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#9CA3AF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" className="flex-shrink-0">
