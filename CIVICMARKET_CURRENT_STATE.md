...
Last updated: July 7, 2026 (Path 1 personalization fix)
...
- **This gap is open again as of July 7 2026 (Path 1 personalization fix, Gate D).** The Gate A-H B2 expansion that previously widened `getOfficialsForUser` so At-Large-holding users saw all five County Commissioners has been disabled. Reason: CivicMarket is personal-action-first — My Current Officials should show only officials tied to the user's own voting/representation districts, not all five County Commissioners just because the user holds the St. Lucie County Commission At-Large district.
